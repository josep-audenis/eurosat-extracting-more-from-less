...
def train_lgbm_cpu(dataset_name, test_size=0.3):
    ...
    print(f"\nTraining LGBMClassifier on CPU on dataset {dataset_name} using a test_size of {test_size*100}%.\n")
...
if __name__ == "__main__":
    ...
    if option == 1:
        ...
        train_lgbm_cpu(dataset_filename)
    elif option == 3:
        pass